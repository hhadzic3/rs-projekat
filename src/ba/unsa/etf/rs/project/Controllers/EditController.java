...
public class EditController {
    ...
    public void initialize() {
        ...
        dpPublishDate.setConverter(new StringConverter<LocalDate>() {
            ...
            {
                dpPublishDate.setPromptText(pattern.toLowerCase());
            }
            @Override
        ...
        isEmptyByListener(fldDirector);
        isEmptyByListener(fldTitle);
        isEmptyByListener(fldCategory);
        ...
        fldDirector.focusedProperty().addListener((ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) -> {
            if(!newValue){ lastFocused = fldDirector;
            }
        });
        fldTitle.focusedProperty().addListener((ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) -> {
            if(!newValue){ lastFocused = fldTitle;
            }
        });
